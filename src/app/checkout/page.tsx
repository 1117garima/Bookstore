                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='form-group'>
                            ...
                            {errors.delivery_address && (
                                <small className='text-red-600'>{errors.delivery_address.message}</small>
                            )}
                        </div>
                        ...
                        <div className='lg:stickyy lg:top-00 z-20 bg-[#f5f5f5] pb-4 pt-8'>
                            ...
                            <div className=' mt-4 grid w-full grid-cols-2 gap-2 text-base'>
                                ...
                                <section className=' justify-self-end'>
                                    ...
                                    <span className=''>{appendCurrencyPrefix(subTotal)}</span>
                                </section>
                            </div>
                        </div>
                                        ...
                                        >
                                            <div className='  flex flex-col bg-white sm:flex-row sm:items-center sm:rounded-lg'>
                                                ...
                                                <div className='flex w-full flex-col px-4 py-4'>
                                                    <span className='text-lg font-semibold'>{item?.book?.title}</span>
                                                    <span className=' text-gray-400 '>
                                                        {/* {item?.product.product_type.name} */}
                                                    </span>
                                                    <p className='text-lg font-bold'>
                                                        {prependCurrency(item?.book.price * item.quantity)}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>

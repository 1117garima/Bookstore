...
//                 <div className='grid-flow-co container my-[40px] gap-4 md:my-[48px]  lg:my-[56px] xl:my-[64px] 2xl:my-[80px]'>
...
//                                             <Order order={order}>
//                                                 <div>
//                                                     {order?.data?.map((orderItem: OrderItem, index: number) => {
//                                                         return (
//                                                             <div key={orderItem.id}>
//                                                                 <div className='mb-1 grid grid-cols-1 items-start gap-2 md:grid-cols-5'>
//                                                                     <img
//                                                                         src={
//                                                                             makeFullUrl(orderItem.images[0]?.image) ||
//                                                                             ''
//                                                                         }
...
//                                                                     <div className='badge-xsx  w-min'>
//                                                                         {orderItem.status}
//                                                                     </div>
//                                                                     {/* <div>FIXME: estimated delivery date </div> */}
//                                                                  </div>
//                                                                 {index + 1 <= order.items.length - 1 && (
//                                                                     <hr className='mx-auto my-4 w-1/2 border border-gray-300' />
//                                                                 )}
//                                                             </div>
//                                                         )
//                                                     })}

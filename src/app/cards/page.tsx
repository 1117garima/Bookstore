                    ...
                    <div className='flex flex-col gap-4 md:flex-row'>
                                ...
                                <table className='w-full'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className='py-4'>
                                                <div className='flex items-center'>
                                                    <button className='mr-2 rounded-md border px-4 py-2'>-</button>
                                                    <span className='w-8 text-center'>1</span>
                                                    <button className='ml-2 rounded-md border px-4 py-2'>+</button>
                                                </div>
                                            </td>
                                            <td className='py-4'>$19.99</td>
                                        </tr>
                        ...
                        <div className='md:w-1/4'>
                            <div className='rounded-lg bg-white p-6 shadow-md'>
                                ...
                                <button className='mt-4 w-full rounded-lg border border-green-700 bg-[#77b748] px-4 py-2 text-white hover:bg-white hover:text-green-700'>
